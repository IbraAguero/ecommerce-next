...
function Newsletter() {
  return (
    <section className="bg-cyan-800 text-white py-16 sm:py-20">
      <div className="max-w-xl mx-auto p-5 flex flex-col items-center">
        ...
        <p className="tracking-wider text-zinc-300 text-sm sm:text-base mt-2">
          Unite al newsletter y recibí tu regalo!
        </p>
        <div className="flex gap-1 w-full mt-5">
          <Input
            placeholder="Correo electronico"
            className="placeholder:text-zinc-300 py-6"
          />
